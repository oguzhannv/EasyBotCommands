...
async function getAll(client, message) {
    const embed = new MessageEmbed()
        ...
        .addField("**BOT MADE BY**", `
        >oguzhannv [\`INVITE\`](https://discord.com/oauth2/authorize?client_id=819217975436509207&scope=bot&permissions=0)
        `)
            .addField("**__Aeuzhan - Supported sources__**", `
        >>> \`Games\`, \`Moderation\`, \`Logs\`, [\`More\`](), ...
        `)
        .addField("****", "[\`Support Server\`](https://discord.gg/MHBUnf3)")
        .setFooter(`To see command descriptions and usage type   ${prefix}help [CMD Name]`, config.AVATARURL)
        .setTitle(`Help Menu\n\nPrefix: \`${prefix}\``)
        .setDescription("***Use the Prefix infront of EACH command, to see its properties!***\n\n***TO GET STARTED:*** Type:  `z!setup`")
