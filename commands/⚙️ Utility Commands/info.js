...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    .addField("***BOT BY:***", `
    >>> <@425215766762356737>  \`oguzhannv#5634\`
    `) .addField("***SUPPORT:***", `
    >>> [\`Server\`](https://discord.gg/33RgR9Gy77) | | [\`Invite\`](https://discord.com/oauth2/authorize?client_id=819217975436509207&scope=bot&permissions=0)
